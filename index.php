...
<?php include('includes/slider.php');?>
    ...
    <div class="container">
        ...
        <h1 class="my-4">You're Most Welcome to The BloodBank & Donor Management System</h1>

        <!-- Marketing Icons Section -->
        <div class="row">
            <div class="col-lg-4 mb-4">
                <div class="card">
                    <h4 class="card-header">Why we need blood?</h4>
...
<p class="card-text"><b>Blood Group :</b> <?php echo htmlentities($result->BloodGroup);?></p>
        ...
        <div class="row">
            <div class="col-lg-6">
                <h2>BLOOD GROUPS</h2>
          <p>  The blood group of any human being will fall in any one of the following groups.</p>
                <ul>
...
<li>D positive or D negative.</li>
                </ul>
                <p>A healthy diet helps ensure a successful blood donation, and also makes you feel better! Check out the following recommended foods to eat in order to mantain your blood prior to your donation.</p>
            </div>
            <div class="col-lg-6">
